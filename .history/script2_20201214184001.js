...
if(rr.includes("product1")!==null){
  document.querySelector(".second1").innerHTML = obj[0].number;
  document.querySelector(".productPriceValue1").innerHTML = obj[0].price;
  document.querySelector(".inputNumber1").innerHTML = 35.00;
