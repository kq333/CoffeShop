...
document.querySelector(".totalAllSpan").innerHTML =  (11.90 + arrySumUp.reduce(calculator)) + " PLN";
  ...
  document.querySelector(".totalAllSpan").innerHTML =  (13.90 + arrySumUp.reduce(calculator)) + " PLN";
...
if(gls4.checked==true){
  ...
  document.querySelector(".totalAllSpan").innerHTML =  (9.90 + arrySumUp.reduce(calculator)) + " PLN";
}
 };
