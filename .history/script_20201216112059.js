...
/////Popracuj nad odejmowaniem z koszyka przyk przucisku "zamknij"
...
btnDelate1.addEventListener(`click`, ()=>{
  ...
  arrPrice = arrPrice.filter(person => person.id1 != 'product1');
  let addd = arrPrice.reduce(function (accumulator, currentValue) {
    return accumulator - currentValue.price 
}, initialValue);
let numberss = arrPrice.reduce(function (accumulator, currentValue) {
  return accumulator - currentValue.number*1;
}, initialValue2);
document.querySelector(".priceTo").innerHTML = (addd)*-1    
document.querySelector(".num").innerHTML = (numberss*1)*-1
document.getElementById("quantity1").value = 0
const value = "a";
...
btnDelate2.addEventListener(`click`, ()=>{
  ...
  arrPrice = arrPrice.filter(person => person.id2 != 'product2');
  let add = arrPrice.reduce(function (accumulator, currentValue) {
    return accumulator - currentValue.price 
    }, initialValue);
let numbers = arrPrice.reduce(function (accumulator, currentValue) {
...
btnDelate3.addEventListener(`click`, ()=>{
  ...
  arrPrice = arrPrice.filter(person => person.id3 != 'product3');
  let add = arrPrice.reduce(function (accumulator, currentValue) {
    return accumulator - currentValue.price 
    }, initialValue);
let numbers = arrPrice.reduce(function (accumulator, currentValue) {
...
btnDelate4.addEventListener(`click`, ()=>{
  ...
  arrPrice = arrPrice.filter(person => person.id4 != 'product4');
  let add = arrPrice.reduce(function (accumulator, currentValue) {
    return accumulator - currentValue.price 
    }, initialValue);
let numbers = arrPrice.reduce(function (accumulator, currentValue) {
...
btnDelate5.addEventListener(`click`, ()=>{
  ...
  arrPrice = arrPrice.filter(person => person.id5 != 'product5');
  let add = arrPrice.reduce(function (accumulator, currentValue) {
    return accumulator - currentValue.price 
    }, initialValue);
let numbers = arrPrice.reduce(function (accumulator, currentValue) {
...
btnDelate6.addEventListener(`click`, ()=>{
  ...
  arrPrice = arrPrice.filter(person => person.id6 != 'product6');
  let add = arrPrice.reduce(function (accumulator, currentValue) {
    return accumulator - currentValue.price 
    }, initialValue);
let numbers = arrPrice.reduce(function (accumulator, currentValue) {
...
btnDelate7.addEventListener(`click`, ()=>{
  ...
  arrPrice = arrPrice.filter(person => person.id7 != 'product7');
  let add = arrPrice.reduce(function (accumulator, currentValue) {
    return accumulator - currentValue.price 
    }, initialValue);
let numbers = arrPrice.reduce(function (accumulator, currentValue) {
...
btnDelate8.addEventListener(`click`, ()=>{
  ...
  arrPrice = arrPrice.filter(person => person.id8 != 'product8');
  let add = arrPrice.reduce(function (accumulator, currentValue) {
    return accumulator - currentValue.price 
    }, initialValue);
let numbers = arrPrice.reduce(function (accumulator, currentValue) {
...
btnDelate9.addEventListener(`click`, ()=>{
  ...
  arrPrice = arrPrice.filter(person => person.id9 != 'product9');
  let add = arrPrice.reduce(function (accumulator, currentValue) {
    return accumulator - currentValue.price 
    }, initialValue);
let numbers = arrPrice.reduce(function (accumulator, currentValue) {
...
btnDelate10.addEventListener(`click`, ()=>{
  ...
  arrPrice = arrPrice.filter(person => person.id10 != 'product10');
  let add = arrPrice.reduce(function (accumulator, currentValue) {
    return accumulator - currentValue.price 
    }, initialValue);
let numbers = arrPrice.reduce(function (accumulator, currentValue) {
...
btnDelate11.addEventListener(`click`, ()=>{
  ...
  arrPrice = arrPrice.filter(person => person.id11 != 'product11');
  let add = arrPrice.reduce(function (accumulator, currentValue) {
    return accumulator - currentValue.price 
    }, initialValue);
let numbers = arrPrice.reduce(function (accumulator, currentValue) {
...
btnDelate12.addEventListener(`click`, ()=>{
  ...
  arrPrice = arrPrice.filter(person => person.id12 != 'product12');
  let add = arrPrice.reduce(function (accumulator, currentValue) {
    return accumulator - currentValue.price 
    }, initialValue);
let numbers = arrPrice.reduce(function (accumulator, currentValue) {
...
btnDelate13.addEventListener(`click`, ()=>{
  ...
  arrPrice = arrPrice.filter(person => person.id13 != 'product13');
  let add = arrPrice.reduce(function (accumulator, currentValue) {
    return accumulator - currentValue.price 
    }, initialValue);
let numbers = arrPrice.reduce(function (accumulator, currentValue) {
...
btnDelate14.addEventListener(`click`, ()=>{
  ...
  arrPrice = arrPrice.filter(person => person.id14 != 'product14');
  let add = arrPrice.reduce(function (accumulator, currentValue) {
    return accumulator - currentValue.price 
    }, initialValue);
let numbers = arrPrice.reduce(function (accumulator, currentValue) {
...
btnDelate15.addEventListener(`click`, ()=>{
  ...
  arrPrice = arrPrice.filter(person => person.id15 != 'product15');
  let add = arrPrice.reduce(function (accumulator, currentValue) {
    return accumulator - currentValue.price 
    }, initialValue);
let numbers = arrPrice.reduce(function (accumulator, currentValue) {
...
function mouseOver(){
  ...
  const list = document.querySelector(".list").style.display = "block"
...
// localStorage.setItem("arrPrice", JSON.stringify(arrPrice));
 //var storedNames = JSON.parse(localStorage.getItem("arrPrice"));
 // console.log(storedNames)