...
if(rr.includes("product1")){
  ...
  const ProductClone = document.querySelector(".productClone");
    ...
    const product1 = document.querySelector(".img");
...
if(rr.includes("product2")){
    document.querySelector(".productPriceValue").innerHTML = obj[1].price;
    document.querySelector(".inputNumber").innerHTML = obj[1].number;
    ...
    const ProductClone = document.querySelector(".productClone");
      ...
      const product2 = document.querySelector(".img");
