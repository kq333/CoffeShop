...
btnAppend1.addEventListener(`click`, () => {
    ...
    if(quantity>0){
      ...
      let intager = document.querySelector(".intager").innerHTML = quantity + " szt.";
     let priceTo =  (myProduct1.quantity*quantity)*myProduct1.price ;
     let totalBasket = document.querySelector(".totalBasketPrice").innerHTML = priceTo + " PLN";  
     document.querySelector(".quant").innerHTML = intager;
     arr.push("a");
...
btnAppend2.addEventListener(`click`, () => {
    ...
    if(quantity>0){
      ...
      document.querySelector(".quant2").innerHTML = intager; 
      arr.push("b");
...
btnAppend3.addEventListener(`click`, () => {
  ...
  if(quantity>0){
    ...
    let totalBasket = document.querySelector(".totalBasketPrice").innerHTML = priceTo + " PLN";
    let basketIntager = document.querySelector(".num").innerHTML = intager;
    document.querySelector(".quant3").innerHTML = intager; 
    arr.push("c");
...
btnAppend4.addEventListener(`click`, () => {
  ...
  if(quantity>0){
    ...
    let totalBasket = document.querySelector(".totalBasketPrice").innerHTML = priceTo + " PLN"; 
    let basketIntager = document.querySelector(".num").innerHTML = intager;
    document.querySelector(".quant4").innerHTML = intager; 
    arr.push("d");
...
btnAppend5.addEventListener(`click`, () => {
  ...
  if(quantity>0){
    ...
    let totalBasket = document.querySelector(".totalBasketPrice").innerHTML = priceTo + " PLN"; 
    let basketIntager = document.querySelector(".num").innerHTML = intager;
    document.querySelector(".quant5").innerHTML = intager; 
    arr.push("e");
...
btnAppend6.addEventListener(`click`, () => {
    ...
    let totalBasket = document.querySelector(".totalBasketPrice").innerHTML = priceTo + " PLN"; 
    let basketIntager = document.querySelector(".num").innerHTML = intager;
    document.querySelector(".quant6").innerHTML = intager; 
    arr.push("f");
...
btnAppend7.addEventListener(`click`, () => {
  ...
  if(quantity>0){
    ...
    let totalBasket = document.querySelector(".totalBasketPrice").innerHTML = priceTo + " PLN"; 
    let basketIntager = document.querySelector(".num").innerHTML = intager;
    document.querySelector(".quant7").innerHTML = intager; 
    arr.push("g");
...
btnAppend8.addEventListener(`click`, () => {
  ...
  if(quantity>0){
    ...
    let totalBasket = document.querySelector(".totalBasketPrice").innerHTML = priceTo + " PLN"; 
    let basketIntager = document.querySelector(".num").innerHTML = intager;
    document.querySelector(".quant8").innerHTML = intager; 
    arr.push("h");
...
const quantity = document.getElementById("quantity9").value;
  if(quantity>0){
    ...
    let totalBasket = document.querySelector(".totalBasketPrice").innerHTML = priceTo + " PLN"; 
    let basketIntager = document.querySelector(".num").innerHTML = intager;
    document.querySelector(".quant9").innerHTML = intager; 
    arr.push("i");
...
btnAppend10.addEventListener(`click`, () => {
  ...
  if(quantity>0){
    ...
    let totalBasket = document.querySelector(".totalBasketPrice").innerHTML = priceTo + " PLN"; 
    let basketIntager = document.querySelector(".num").innerHTML = intager;
    document.querySelector(".quant10").innerHTML = intager; 
    arr.push("j");
...
btnAppend11.addEventListener(`click`, () => {
  ...
  if(quantity>0){
    ...
    let totalBasket = document.querySelector(".totalBasketPrice").innerHTML = priceTo + " PLN"; 
    let basketIntager = document.querySelector(".num").innerHTML = intager;
    document.querySelector(".quant11").innerHTML = intager; 
    arr.push("k");
...
btnAppend12.addEventListener(`click`, () => {
  ...
  if(quantity>0){
    ...
    let totalBasket = document.querySelector(".totalBasketPrice").innerHTML = priceTo + " PLN"; 
    let basketIntager = document.querySelector(".num").innerHTML = intager;
    document.querySelector(".quant12").innerHTML = intager; 
    arr.push("l");
...
btnAppend13.addEventListener(`click`, () => {
  ...
  if(quantity>0){
    ...
    let totalBasket = document.querySelector(".totalBasketPrice").innerHTML = priceTo + " PLN"; 
    let basketIntager = document.querySelector(".num").innerHTML = intager;
    document.querySelector(".quant13").innerHTML = intager; 
    arr.push("m");
...
btnAppend14.addEventListener(`click`, () => {
  ...
  if(quantity>0){
    ...
    let totalBasket = document.querySelector(".totalBasketPrice").innerHTML = priceTo + " PLN"; 
    let basketIntager = document.querySelector(".num").innerHTML = intager;
    document.querySelector(".quant14").innerHTML = intager; 
    arr.push("n");
...
btnAppend15.addEventListener(`click`, () => {
  ...
  if(quantity>0){
    ...
    let totalBasket = document.querySelector(".totalBasketPrice").innerHTML = priceTo + " PLN"; 
    let basketIntager = document.querySelector(".num").innerHTML = intager;
    document.querySelector(".quant15").innerHTML = intager; 
    arr.push("o");
...
document.querySelector(".basketName").onmouseout = function() {mouseOut()};
 ...
 mouseOut = () =>{
  ...
  const r2 = document.querySelector(".l2");
  const r3 = document.querySelector(".l2");
  const r4 = document.querySelector(".l2");
  const r5 = document.querySelector(".l2");
  const r6 = document.querySelector(".l2");
  const r7 = document.querySelector(".l2");
  const r8 = document.querySelector(".l2");
  const r9 = document.querySelector(".l2");
  const r10 = document.querySelector(".l2");
  const r11 = document.querySelector(".l2");
  const r12 = document.querySelector(".l2");
  const r13 = document.querySelector(".l2");
  const r14 = document.querySelector(".l2");
  const r15 = document.querySelector(".l2");

var isVisible = (r.style.display != "none");
var isVisible2 = (r2.style.display != "none");
var isVisible3 = (r3.style.display != "none");
var isVisible4 = (r4.style.display != "none");
var isVisible5 = (r5.style.display != "none");
var isVisible6 = (r6.style.display != "none");
var isVisible7 = (r7.style.display != "none");
var isVisible8 = (r8.style.display != "none");
var isVisible9 = (r9.style.display != "none");
var isVisible10 = (r10.style.display != "none");
var isVisible11 = (r11.style.display != "none");
var isVisible12 = (r12.style.display != "none");
var isVisible13 = (r13.style.display != "none");
var isVisible14 = (r14.style.display != "none");
var isVisible15 = (r15.style.display != "none");


if(isVisible ==true || isVisible2 ==true || isVisible3 ==true || isVisible4 ==true || isVisible5 ==true || isVisible6 ==true || isVisible7 ==true || isVisible8 ==true || isVisible9 ==true || isVisible10 ==true || isVisible11 ==true || isVisible12 ==true || isVisible13 ==true ||isVisible14 ==true || isVisible15 ==true){
