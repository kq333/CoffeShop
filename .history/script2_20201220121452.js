...
document.querySelector(".second2").innerHTML = obj[index2].number + " szt.";
 ...
 if(rr.includes("product14")){
  ...
  let numArray = arrySumUp.sort((a, b) => b - a);


let add = arrySumUp.reduce((a,b) =>
   a+b);

let odd = numArray.reduce((a,b) =>
   a-b);
...
if (index > -1) {
 ...
 document.querySelector(".totalValue").innerHTML = arrySumUp - sumaa + " PLN";

document.querySelector(".totalAllSpan").innerHTML =  sumaa;
