...
if(gls4.checked==true){
 ...
 check = () =>{
 const a = gls1.checked=true;
 const b =  gls2.checked=true;
const c =   gls3.checked=true;
const d =   gls4.checked=true;

if(a==true){
  document.getElementById("btnOrder1").disabled = false;
}
if(b==true){
  document.getElementById("btnOrder1").disabled = false;
}
...
if(arrySumUp && arrySumUp.length==0){
  ...
  delateBasket1.addEventListener(`click`, ()=>{
...
unCheck();
 ...
 document.querySelector(".totalAllSpan").innerHTML = arrySumUp.reduce(calculator) + " PLN";
  ...
  delateBasket2.addEventListener(`click`, ()=>{
...
delateBasket3.addEventListener(`click`, ()=>{
...
delateBasket4.addEventListener(`click`, ()=>{
...
delateBasket5.addEventListener(`click`, ()=>{
...
delateBasket6.addEventListener(`click`, ()=>{
...
delateBasket7.addEventListener(`click`, ()=>{
...
delateBasket8.addEventListener(`click`, ()=>{
...
delateBasket9.addEventListener(`click`, ()=>{
...
delateBasket10.addEventListener(`click`, ()=>{
...
delateBasket11.addEventListener(`click`, ()=>{
...
delateBasket12.addEventListener(`click`, ()=>{
...
delateBasket13.addEventListener(`click`, ()=>{
...
delateBasket14.addEventListener(`click`, ()=>{
...
delateBasket15.addEventListener(`click`, ()=>{
...
const transfer1 = document.querySelector(".transfer1").checked=true;
...
const btnOrder1 = document.getElementById("btnOrder1").disabled = true;
