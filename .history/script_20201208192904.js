...
document.querySelector(".border").onmouseover = function() {mouseOver2()};
document.querySelector(".border").onmouseout = function() {mouseOut2()};


  setTimeout(function mouseOver() {document.querySelector(".list").style.display = "block"},3000);
