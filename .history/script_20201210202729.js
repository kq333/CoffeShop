...
//localStorage.setItem("arrPrice", arrPrice);


let arrPrice_serialised = JSON.stringify(arrPrice)

localStorage.setItem("arrPrice", arrPrice_serialised);

const local = document.getElementById("local");

local.addEventListener(`click`, ()=>{
  console.log(arrPrice_serialised)
