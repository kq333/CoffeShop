...
if(rr.includes("product1")){
  document.querySelector(".second1").innerHTML = obj[0].number1 + " szt.";
  document.querySelector(".productPriceValue1").innerHTML = obj[0].price1  + " PLN" ;
...
if(rr.includes("product2")){
  document.querySelector(".second2").innerHTML = obj[0].number2 + " szt.";
  document.querySelector(".productPriceValue2").innerHTML = obj[0].price2  + " PLN" ;
  ...
  if(rr.includes("product3")){
    ...
    document.querySelector(".second3").innerHTML = obj[0].number3 + " szt.";
  document.querySelector(".productPriceValue3").innerHTML = obj[0].price3  + " PLN" ;
