...
const transfer1 = document.querySelector(".transfer1");
const transfer2 = document.querySelector(".transfer2");

document.getElementsById("btnOrder").addEventListener(`click`, ()=>{
  if(transfer1.checked=false){
    alert("sdssd");
