...
if (index > -1) {
 ...
 document.querySelector(".totalValue").innerHTML = add-odd + " PLN";

document.querySelector(".totalAllSpan").innerHTML =  add;
  ...
  delateBasket2.addEventListener(`click`, function(){
     ...
     document.querySelector(".totalValue").innerHTML = add + " PLN";
...
delateBasket4.addEventListener(`click`, function(){
 ...
 document.querySelector(".totalValue").innerHTML = arrySumUp + " PLN";
