...
if(rr.includes("product2")){
  ...
  document.querySelector(".productPriceValue2").innerHTML = obj[1].price  + " PLN" ;
  ...
  document.querySelector(".productPriceValue3").innerHTML = obj[2].price  + " PLN" ;
  document.querySelector(".inputNumber3").innerHTML = 45.00 + " PLN";
