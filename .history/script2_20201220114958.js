...
if (index > -1) {
 ...
 document.querySelector(".totalValue").innerHTML = odd + " PLN";

document.querySelector(".totalAllSpan").innerHTML =  odd;
  ...
  delateBasket2.addEventListener(`click`, function(){
     ...
     document.querySelector(".totalValue").innerHTML = odd(-1) + " PLN";

    document.querySelector(".totalAllSpan").innerHTML = odd(-1) ;
