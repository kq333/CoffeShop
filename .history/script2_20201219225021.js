...
if(obj.includes("product1")){
  ...
  arrySumUp.push(obj[index].price)


}


if(obj.includes("product2")){

document.querySelector(".second2").innerHTML = obj[index2].number + " szt.";
 let productPriceValue2 =  document.querySelector(".productPriceValue2").innerHTML = obj[index2].price  + " PLN" ;
...
let add = arrySumUp.reduce((a,b) =>
   a+b);

let odd = arrySumUp.reduce((a,b) =>
   a-b)   

let totalValue = document.querySelector(".totalValue").innerHTML = add + " PLN";
...
document.querySelector(".totalAllSpan").innerHTML =  (11.90 + add) + " PLN";
  ...
  document.querySelector(".totalAllSpan").innerHTML =  (13.90 + add) + " PLN";
...
if(gls4.checked==true){
  ...
  document.querySelector(".totalAllSpan").innerHTML =  (9.90 + add) + " PLN";
}
 };
...
let totalValue = document.querySelector(".totalValue").innerHTML = arrySumUp + " PLN";

document.querySelector(".totalAllSpan").innerHTML =  arrySumUp;
